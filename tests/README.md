...
`Q1:` _I have a shell script that runs my tests and I don't want to rewrite it._
...
repository._ `A2:` Before a testrun or test session, just add your test
...
them to the common s3 bucket._ `A4:` Add your custom images to the `build/img`
...
`Q5:` _How can I get live logger output from the tests?_ `A5:` Accessing
